...
class ProcessVideoApiService {
  ...
  processVideo = async (
    ...
    try {
      let data: ProcessVideoResponse = await this.httpClientWrapper.post(
        "process-video",
        payload
      );
      return data;
  ...
  getAnalytics = async (analyticsId: string): Promise<string> => {
    try {
      let data: string = await this.httpClientWrapper.get(
  ...
  deleteAnalytics = async (analyticsId: string): Promise<string> => {
    try {
      let data: string = await this.httpClientWrapper.delete(
        `analytics/${analyticsId}`
      );
      return data;
    } catch (error) {
  ...
  getAnalyticsInsights = async (
    ...
    try {
      let data: AnalyticsInsightsResponse = await this.httpClientWrapper.get(
        `analytics/${analyticsId}/insights`
      );
      return data;
    } catch (error) {
      throw error;
  ...
  getAnalyticsList = async (
    ...
    try {
      ...
      let data: AnalyticsListResponse = await this.httpClientWrapper.get(
        endpoint
      );
      return data;
    } catch (error) {
  ...
  bulkDelete = async (
    ...
    try {
      let data: BulkDeleteResponse = await this.httpClientWrapper.post(
        "bulk/delete",
        payload
      );
      return data;
