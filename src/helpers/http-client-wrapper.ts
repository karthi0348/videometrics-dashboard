...
class HttpClientWrapper {
  ...
  public postWithoutAuth = async (path: string, payload: any) => {
    try {
      let response: any = await this.axiosClient.post(
        path,
        payload,
        this.getJsonHeaderConfigWithoutAuth()
      );
      return response;
    } catch (err: any) {
      throw err;
  ...
  public get = async (path: string, payload?: any) => {
    try {
      let response: any = await this.axiosClient.get(
        path,
        this.getJsonHeaderConfig()
      );
  ...
  public put = async (path: string, payload?: any) => {
    try {
      let response: any = await this.axiosClient.put(
        path,
        payload,
        this.getJsonHeaderConfig()
      );
  ...
  public patch = async (path: string, payload?: any) => {
    try {
      let response: any = await this.axiosClient.patch(
        path,
        payload,
        this.getJsonHeaderConfig()
      );
  ...
  public delete = async (path: string) => {
    try {
      let response: any = await this.axiosClient.delete(
        path,
        this.getJsonHeaderConfig()
      );
      return response.data.data;
  ...
  public postFormDataWithoutAuth = async (path: string, formData: FormData) => {
    try {
      let response: any = await this.axiosClient.post(
        path,
        formData,
        this.getFormDataHeaderConfigWithoutAuth()
      );
      return response.data;
    } catch (err: any) {
      throw err;
  ...
  public doLogout = async (path: string) => {
    try {
      let response: any = await this.axiosClient.post(
        path,
        "",
        this.getJsonHeaderConfigWithAuth()
      );
      return response;
    } catch (err: any) {
      throw err;
