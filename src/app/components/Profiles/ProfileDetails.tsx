    ...
    <div className="min-h-screen rounded-2xl p-4 sm:p-6 lg:p-8 x  bg-gradient-to-br from-blue-300 via-purple-500 to-indigo-100 space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 space-y-4 sm:space-y-0">
        <div className="flex-1 min-w-0">
          <div className="text-xl md:text-2xl font-bold bg-gradient-to-r from-purple-900 to-indigo-600 bg-clip-text text-transparent">
            Profile Details
          </div>
      ...
      {/* Main Content */}
      <div
        className="bg-white rounded-lg border p-4 sm:p-6 space-y-4"
        style={{
          borderColor: "rgb(196, 127, 254, 0.3)",
          boxShadow:
            "0 4px 6px -1px rgb(81, 77, 223, 0.05), 0 2px 4px -1px rgb(81, 77, 223, 0.03)",
        }}
      >
        {isEditing ? (
