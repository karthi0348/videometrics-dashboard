  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Sub-Profiles</h2>
...
//   // Create sub-profile using existing service
//   const handleCreateSubProfile = async (subProfileData: CreateSubProfileRequest) => {
//     try {
//       setCreating(true);
//       setError(null);
//       const newSubProfile = await subProfileService.createSubProfile(profile.id, subProfileData);
...
//   // Update sub-profile using existing service
//   const handleUpdateSubProfile = async (subProfileId: string, updateData: Partial<CreateSubProfileRequest>) => {
//     try {
//       setUpdating(true);
//       setError(null);
//       const updatedSubProfile = await subProfileService.updateSubProfile(profile.id, subProfileId, updateData);
...
//   // Delete sub-profile using existing service
//   const handleDeleteSubProfile = async (subProfileId: string) => {
//     try {
//       setDeleting(true);
//       setError(null);
//       await subProfileService.deleteSubProfile(profile.id, subProfileId);
...
//     const isActive = subProfile.status === 'active';
//     const matchesFilter = filterByActive === null || isActive === filterByActive;
...
//                     onClick={() => handleToggleActive(subProfile)}
//                     className={`w-3 h-3 rounded-full transition-colors ${
//                       subProfile.status === 'active' 
//                         ? 'bg-green-400 hover:bg-green-500' 
//                         : 'bg-gray-300 hover:bg-gray-400'
//                     }`}
//                     title={`${subProfile.status === 'active' ? 'Active' : 'Inactive'} - Click to toggle`}
//                   />
//                   <div className="relative">
//                     <button className="p-1 hover:bg-gray-100 rounded">
//                       <MoreVertical className="w-4 h-4 text-gray-400" />
...
//               <div className="flex items-center gap-4 text-xs text-gray-500 mb-4">
//                 <span>
//                   {Array.isArray(subProfile.cameraLocations) ? subProfile.cameraLocations.length : 0} cameras
//                 </span>
//                 <span>
//                   {Array.isArray(subProfile.monitoringSchedule) ? subProfile.monitoringSchedule.length : 0} schedules
//                 </span>
//                 <span>
//                   {Array.isArray(subProfile.alertSettings) ? subProfile.alertSettings.length : 0} alerts
//                 </span>
//               </div>
...
//               <div className="flex items-center justify-between pt-4 border-t border-gray-100">
//                 <div className="text-xs text-gray-500">
//                   Updated {formatDate(subProfile.lastUpdated)}
//                 </div>
//                 <div className="flex items-center gap-1">
//                   <button
//                     onClick={() => handleViewSubProfile(subProfile.id)}
